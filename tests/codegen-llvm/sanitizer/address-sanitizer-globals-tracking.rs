...
//@                compile-flags: -Copt-level=0 -Ctarget-feature=-crt-static -Cunsafe-allow-abi-mismatch=sanitize
//@[ASAN]          compile-flags: -Zunstable-options -Csanitize=address
//@[ASAN-FAT-LTO]  compile-flags: -Clto=fat -Cprefer-dynamic=false  -Zunstable-options -Csanitize=address
